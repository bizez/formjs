...
function previewp(obj){
    ...
    if (isInArray(arr,extension)) {
        ...
        var tcmt = document.getElementById("tcmt");
          ...
          document.getElementById("msg").innerHTML='仅支持:jpeg jpg JPG png gif pdf文件!';            
   ...
   var hostname=window.location.href;
    ...
    var phone = document.getElementById("phoneb").value;
      if(name==""){
          ...
          var tcmt = document.getElementById("tcmt");
          tcmt.style.display= "block";
          document.getElementById("msg").innerHTML='请输入你的姓名';
    ...
    if(masg==""){
        ...
        var tcmt = document.getElementById("tcmt");
          tcmt.style.display= "block";
          document.getElementById("msg").innerHTML='请输入留言内容';
        return false;
    }
	...
	if(masg.length>3000 || masg.length<20){
        var tcmt = document.getElementById("tcmt");
          tcmt.style.display= "block";
          document.getElementById("msg").innerHTML='留言内容必须有20-3000个字符!';
  ...
  form.append("hostname", hostname);
    ...
    xhr.send(form); //开始上传，发送form数据
     var cover1 = document.getElementById("cover1");
        ...
        document.getElementById("bt").innerHTML='邮件发送成功';
     document.getElementById("nr").innerHTML='我们会尽快通过邮件或者电话联系您，谢谢！';
...
function namebs(){
	...
	document.getElementById("masgb").placeholder = '';
		...
		function namebs2(){
			document.getElementById("nameb").placeholder = '请输入你的姓名';
		}
		function emailbs(){
			document.getElementById("nameb").placeholder = '请输入你的姓名';
